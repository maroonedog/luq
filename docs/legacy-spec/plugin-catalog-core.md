...
- Meaning: Declared and re-exported from src/index.ts as a public type, accepted via ValidationOptions.severity, but NOT consulted by any plugin or by the executor in this area — currently dead weight in the public surface.

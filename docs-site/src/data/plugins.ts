...
export const plugins: readonly PluginInfo[] = [
  ...
  },
  {
    ...
    slots: ["object", "array", "string", "number", "boolean"],
    tier: "isolated",
    parameters: [
      {
        name: "condition",
  ...
  },
  {
    ...
    method: "readOnly",
    slots: ["string", "number", "boolean", "date", "array", "object"],
    tier: "isolated",
    parameters: [],
    description:
  ...
  },
  {
    ...
    method: "transform",
    slots: ["string", "number", "boolean", "date", "array", "object", "union"],
    tier: "isolated",
    parameters: [
      {
        name: "map",
